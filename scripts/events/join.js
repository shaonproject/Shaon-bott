...
module.exports.run = async function({ api, event, Users }) {
  ...
  if (event.logMessageData.addedParticipants && Array.isArray(event.logMessageData.addedParticipants) && event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
    ...
    let gifUrl = 'https://i.imgur.com/RFM00EP.jpg',
    'https://i.imgur.com/zydjbiZ.jpg',
  'https://i.imgur.com/aYr4tmB.jpg',
  'https://i.imgur.com/l7swSuq.jpg',
  'https://i.imgur.com/UaxkX6s.jpg'
...
🟢SUPPORT EMAIL: www.shaonproject25@gamil.com`, attachment: fs.createReadStream(gifPath)}, threadID));
  }})
.catch(error => {
    console.error(error);
});
